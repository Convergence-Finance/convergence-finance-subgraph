...
export class Token extends Entity {
  ...
  get liquidityInUsd(): BigDecimal {
    let value = this.get("liquidityInUsd");
    return value.toBigDecimal();
  }

  set liquidityInUsd(value: BigDecimal) {
    this.set("liquidityInUsd", Value.fromBigDecimal(value));
  }
  ...
  get usdPriceToken(): Array<string> {
    let value = this.get("usdPriceToken");
    return value.toStringArray();
  }

  set usdPriceToken(value: Array<string>) {
    this.set("usdPriceToken", Value.fromStringArray(value));
  }
}
...
export class SwapPairFeeInfoByLast extends Entity {
  ...
  get convPirce(): BigDecimal {
    let value = this.get("convPirce");
    return value.toBigDecimal();
  }

  set convPirce(value: BigDecimal) {
    this.set("convPirce", Value.fromBigDecimal(value));
  }
