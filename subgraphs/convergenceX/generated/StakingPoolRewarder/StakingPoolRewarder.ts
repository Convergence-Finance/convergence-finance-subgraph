...
export class StakingPoolRewarder extends ethereum.SmartContract {
  ...
  calculateWithdrawableFromVesting(user: Address, poolId: BigInt): BigInt {
    let result = super.call(
      "calculateWithdrawableFromVesting",
      "calculateWithdrawableFromVesting(address,uint256):(uint256)",
      [
  ...
  try_calculateWithdrawableFromVesting(
    user: Address,
    poolId: BigInt
